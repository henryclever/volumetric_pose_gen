...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.do2 = nn.Dropout(p=0.1, inplace=False)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.avgpool = nn.AvgPool2d((4, 2), stride=1)
...
def resnet34(pretrained=False, output_size = None, **kwargs):
    ...
    # Update the final layer of a pretrained model so that the output dimensionality matches our problem
    model.fc = nn.Linear(512 * model.block.expansion, output_size)
    return model
