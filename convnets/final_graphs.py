...
class DataVisualizer():
    ...
    def __init__(self, pkl_directory,  opt):
        ...
        for key in train_val_loss4:
            print key
        train_val_loss5 = load_pickle(self.dump_path + '/planesreg_correction/DC_L2depth/convnet_losses_anglesDC_synth_32000_128b_x5pmult_0.5rtojtdpth_depthestin_angleadj_l2cnt_125e_300e_00001lr.p')
        ...
        #                  corrected_y1, 'r')
        plt.legend(['relu', 'relu val',' relu correction', 'relu val correction'])
        plt.grid()
        plt.xlabel('epochs')
        plt.ylabel('loss')
        ...
        for key in train_val_loss5:
            print key
        train_val_loss6 = load_pickle(self.dump_path + '/planesreg_correction/DC_L2depth/convnet_losses_anglesDC_synth_32000_128b_x5pmult_0.5rtojtdpth_depthestin_angleadj_alltanh_l2cnt_125e_300e_00001lr.p')
        ...
        plt.legend(['tanh', 'tanh val',' tanh correction', 'tanh val correction'])
        plt.grid()
        plt.xlabel('epochs')
        plt.ylabel('loss')
        ...
        plt.subplot(2, 2, 4)
        plt.tight_layout()
        plt.title('Training size: 112K')
        plt.axis([0,300,2000,3000])
        #plt.yticks([])
        train_val_loss1 = load_pickle(self.dump_path + '/planesreg/DC_L2depth/convnet_losses_anglesDC_synth_112000_128b_x5pmult_0.5rtojtdpth_alltanh_l2cnt_100e_00001lr.p')
        for key in train_val_loss1:
            print key
        train_val_loss2 = load_pickle(self.dump_path + '/planesreg_correction/DC_L2depth/convnet_losses_anglesDC_synth_112000_128b_x5pmult_0.5rtojtdpth_depthestin_angleadj_alltanh_l2cnt_50e_100e_00001lr.p')
        for key in train_val_loss2:
            print key
        #train_val_loss1_cor = load_pickle(self.dump_path + '/planesreg_correction/convnet_losses_anglesEU_synth_s9_3xreal_128b_1.0rtojtdpth_pmatcntin_depthestin_angleadj_100e_000005lr.p')
