        ...
        if self.loss_vector_type == 'anglesDC':
            self.bounds = torch.Tensor(
                np.array([[-np.pi / 3, np.pi / 3], [-np.pi / 36, np.pi / 36], [-np.pi / 3, np.pi / 3],
                          ...
                          [-0.810063927501682, 0.421484532214729],
                          ...
                          [-1.8674195346872975 * 1 / 3, 1.410545172086535 * 1 / 3],
                          [-1.530112726921327 * 1 / 3, 1.2074724617209949 * 1 / 3],
                          [-1.9550515937478927 * 1 / 3, 1.7587935205169856 * 1 / 3],
                          [-1.8674195346872975 * 1 / 3, 1.410545172086535 * 1 / 3],
                          [-1.2074724617209949 * 1 / 3, 1.530112726921327 * 1 / 3],
                          [-1.7587935205169856 * 1 / 3, 1.9550515937478927 * 1 / 3],
                          [-np.pi / 3, np.pi / 3], [-np.pi / 36, np.pi / 36], [-np.pi / 36, np.pi / 36],  # head
                          [-1.8674195346872975 * 2 / 3, 1.410545172086535 * 2 / 3],
                          [-1.530112726921327 * 2 / 3, 1.2074724617209949 * 2 / 3],
                          [-1.9550515937478927 * 2 / 3, 1.7587935205169856 * 2 / 3],
                          [-1.8674195346872975 * 2 / 3, 1.410545172086535 * 2 / 3],
                          [-1.2074724617209949 * 2 / 3, 1.530112726921327 * 2 / 3],
                          [-1.7587935205169856 * 2 / 3, 1.9550515937478927 * 2 / 3],
