        ...
        if loss_vector_type == 'anglesR' or loss_vector_type == 'anglesDC' or loss_vector_type == 'anglesEU':
            ...
            if self.loss_vector_type == 'anglesDC':
                self.bounds = torch.Tensor(np.array([[-np.pi/3, np.pi/3], [-np.pi/3, np.pi/3], [-np.pi/3, np.pi/3],
                                       [-2.655719256295683, -0.022624800749700587], [-1.1628766943205007, 0.9340170076795724], [-0.37290106435540205, 0.9190375825276169],
                                       [-2.655719256295683, -0.022624800749700587], [-0.9340170076795724, 1.1628766943205007],  [-0.9190375825276169, 0.37290106435540205],
                                       [-np.pi / 6, np.pi / 6], [-np.pi / 36, np.pi / 36], [-np.pi / 36, np.pi / 36],
                                       [0.0, 2.6869091212979197], [-0.01, 0.01], [-0.01, 0.01],  # knee
                                       [0.0, 2.6869091212979197], [-0.01, 0.01], [-0.01, 0.01],
                                       [-np.pi / 6, np.pi / 6], [-np.pi / 36, np.pi / 36], [-np.pi / 36, np.pi / 36],
                                       ...
                                       [-1.7987714393846532* 1 / 3, 1.3841366870162246 * 1 / 3], [-1.5412375493997066 * 1 / 3, 1.2301399685794014 * 1 / 3], [-1.9634126434375496 * 1 / 3, 1.9050155394491972 * 1 / 3],
                                       [-1.7987714393846532 * 1 / 3, 1.3841366870162246 * 1 / 3], [-1.2301399685794014 * 1 / 3, 1.5412375493997066 * 1 / 3], [-1.9050155394491972 * 1 / 3, 1.9634126434375496 * 1 / 3],
                                       [-np.pi / 6, np.pi / 6], [-np.pi / 36, np.pi / 36], [-np.pi / 36, np.pi / 36],  # head
                                       [-1.7987714393846532 * 2 / 3, 1.3841366870162246 * 2 / 3], [-1.5412375493997066 * 2 / 3, 1.2301399685794014 * 2 / 3], [-1.9634126434375496 * 2 / 3, 1.9050155394491972 * 2 / 3],
                                       [-1.7987714393846532 * 2 / 3, 1.3841366870162246 * 2 / 3], [-1.2301399685794014 * 2 / 3, 1.5412375493997066 * 2 / 3], [-1.9050155394491972 * 2 / 3, 1.9634126434375496 * 2 / 3],
                                       [-0.01, 0.01], [-2.4028118143418453, 0.0], [-0.01, 0.01],  # elbow
                                       [-0.01, 0.01], [0.0, 2.4028118143418453],  [-0.01, 0.01],  # elbow
                ...
                self.bounds = torch.Tensor(np.array([[-np.pi/3, np.pi/3], [-np.pi/3, np.pi/3], [-np.pi/3, np.pi/3],
                                       [-2.6607395677775267, -0.09875784970484419], [-1.1456633381414434, 0.9242110305554005], [-0.6136571693996525, 1.0672105263716434],
                                       [-2.6607395677775267, -0.09875784970484419], [-0.9242110305554005, 1.1456633381414434], [-1.0672105263716434, 0.6136571693996525],
                                       [-np.pi / 6, np.pi / 6], [-np.pi / 36, np.pi / 36], [-np.pi / 36, np.pi / 36],
                                       [0.0, 2.6869091212979197], [-0.01, 0.01], [-0.01, 0.01],  # knee
                                       [0.0, 2.6869091212979197], [-0.01, 0.01], [-0.01, 0.01],
                                       [-np.pi / 6, np.pi / 6], [-np.pi / 36, np.pi / 36], [-np.pi / 36, np.pi / 36],
                                       ...
                                       [-0.01, 0.01], [-0.01, 0.01], [-0.01, 0.01],  # foot
                                       [-np.pi / 6, np.pi / 6], [-np.pi / 36, np.pi / 36], [-np.pi / 36, np.pi / 36],  # neck
                                       [-1.5699274029231267 * 1 / 3, 1.7035352450864831* 1 / 3], [-1.5707091233756612 * 1 / 3, 0.8049689918025631 * 1 / 3], [-2.0600980542590266 * 1 / 3, 2.0329633375529856 * 1 / 3],
                                       [-1.5699274029231267 * 1 / 3, 1.7035352450864831 * 1 / 3], [-0.8049689918025631 * 1 / 3, 1.5707091233756612 * 1 / 3], [-2.0329633375529856 * 1 / 3, 2.0600980542590266 * 1 / 3],
                                       [-np.pi / 6, np.pi / 6], [-np.pi / 36, np.pi / 36], [-np.pi / 36, np.pi / 36],  # head
                                       [-1.5699274029231267 * 2 / 3, 1.7035352450864831 * 2 / 3], [-1.5707091233756612 * 2 / 3, 0.8049689918025631 * 2 / 3], [-2.0600980542590266 * 2 / 3, 2.0329633375529856 * 2 / 3],
                                       [-1.5699274029231267 * 2 / 3, 1.7035352450864831 * 2 / 3], [-0.8049689918025631 * 2 / 3, 1.5707091233756612 * 2 / 3], [-2.0329633375529856 * 2 / 3, 2.0600980542590266 * 2 / 3],
