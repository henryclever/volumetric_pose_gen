...
class PhysicalTrainer():
    ...
    def __init__(self, training_database_file_f, training_database_file_m, testing_database_file_f,
        ...
        dat_f_synth = TensorPrepLib().load_files_to_database(training_database_file_f, 'synth', 'training f synth')
        dat_m_synth = TensorPrepLib().load_files_to_database(training_database_file_m, 'synth', 'training m synth')
        dat_f_real = TensorPrepLib().load_files_to_database(training_database_file_f, 'real', 'training f real')
        dat_m_real = TensorPrepLib().load_files_to_database(training_database_file_m, 'real', 'training m real')
        ...
        test_dat_f = TensorPrepLib().load_files_to_database(testing_database_file_f, 'real', 'training f real')
        test_dat_m = TensorPrepLib().load_files_to_database(testing_database_file_m, 'real', 'training f real')
