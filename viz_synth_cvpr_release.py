...
# the data here is loaded the same as it is for training.
import argparse
import torch
...
if __name__ == "__main__":
    ...
    if GENDER == "f":
        test_database_file_f.append(filepath_prefix+'synth/random3_supp/'+TESTING_FILENAME+'.p')
        model_path = '/home/henry/git/SMPL_python_v.1.0.0/smpl/models/basicModel_f_lbs_10_207_0_v1.0.0.pkl'
    else:
        test_database_file_m.append(filepath_prefix+'synth/random3_supp/'+TESTING_FILENAME+'.p')
