...
class GeneratePose():
    def __init__(self, filepath_prefix = '/home/henry'):
        ...
        self.CTRL_PNL['recon_map_labels_test'] = False
        self.CTRL_PNL['recon_map_output'] = self.CTRL_PNL['recon_map_labels']
        ...
        self.CTRL_PNL['cal_noise_amt'] = 0.0
    ...
    def estimate_real_time(self, filename1, filename2 = None):
        ...
        while not rospy.is_shutdown():
            ...
            pmat = np.fliplr(np.flipud(np.clip(self.pressure.reshape(mat_size)*float(4), a_min=0, a_max=100)))
            ...
            pmat_stack = PreprocessingLib().preprocessing_create_pressure_angle_stack_realtime(pmat, self.bedangle, mat_size, return_height = False)
            ...
            pmat_std_from_mult = ['N/A', 11.70153502792190, 19.90905848383454, 23.07018866032369, 0.0,
                                  25.50538629767412]
            if self.CTRL_PNL['cal_noise'] == False:
            ...
            print self.CTRL_PNL['num_input_channels'], batch[0].size(), 'inputs and batch size'

            scores, INPUT_DICT, OUTPUT_DICT = UnpackBatchLib().unpack_batch(batch, False, model, self.CTRL_PNL)
            ...
            if model2 is not None:
                ...
                self.CTRL_PNL['recon_map_output'] = True
                scores, INPUT_DICT, OUTPUT_DICT = UnpackBatchLib().unpack_batch(batch_cor, False, model2, self.CTRL_PNL)
            ...
            pyRender.mesh_render_pose_bed_orig(self.m, root_shift_est, self.point_cloud_array, self.pc_isnew, pmat*4, self.markers, self.bedangle)
            self.point_cloud_array = None
...
if __name__ ==  "__main__":
    ...
    #cvpr paper
    #generator.estimate_real_time(filepath_prefix+"/data/convnets/planesreg/FINAL/convnet_anglesDC_synth_184000_128b_x5pmult_1.0rtojtdpth_tnhFIXN_calnoise_100e_00002lr.pt",
    #                             filepath_prefix+"/data/convnets/planesreg_correction/FINAL/convnet_anglesDC_synth_184000_128b_x5pmult_0.5rtojtdpth_depthestin_angleadj_tnhFIXN_calnoise_100e_00002lr.pt")


    #latest convnet
    generator.estimate_real_time(filepath_prefix+"/git/sim_camera_resting_scene/data_BR/convnets/resnet50_1_anglesDC_184000ct_128b_x1pm_tnh_clns20p_100e_0.0001lr.pt",
                                 filepath_prefix+"/git/sim_camera_resting_scene/data_BR/convnets/resnet50_2_anglesDC_184000ct_128b_x1pm_0.5rtojtdpth_depthestin_angleadj_tnh_clns20p_40e_0.0001lr.pt")
